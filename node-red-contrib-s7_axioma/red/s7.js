...
//		connect(connOpts)
	...
	function siemens_flex_conn(config) {
        RED.nodes.createNode(this,config);
        var node = this;
    ...
    RED.nodes.registerType("siemens_flex_conn axioma",siemens_flex_conn);
	
	function siemens_flex_var(config) {
        RED.nodes.createNode(this,config);
        var node = this;
        node.on('input', function(msg) {
			node.endpoint = RED.nodes.getNode(config.endpoint);
    ...
    RED.nodes.registerType("siemens_flex_var axioma",siemens_flex_var);
};
